...
export const NavbarItem = forwardRef(function NavbarItem(
  ...
  let classes = clsx(
    ...
    // Hover
    'data-[hover]:bg-rose-500/5 data-[slot=icon]:*:data-[hover]:fill-rose-500',
    // Active
    'data-[active]:bg-rose-500/5 data-[slot=icon]:*:data-[active]:fill-rose-500 data-[current]:text-rose-500',
    // Dark mode
    'dark:text-white dark:data-[slot=icon]:*:fill-rose-400',
    ...
    <span className={clsx(className, 'relative')}>
      {current && (
        <motion.span
          ...
          className="absolute inset-x-2 -bottom-2.5 h-0.5 rounded-full bg-rose-500 dark:bg-white"
        />
      )}
      {'href' in props ? (
        <Link
