...
export const SidebarItem = forwardRef(function SidebarItem(
  ...
  let classes = clsx(
    ...
    // Active
    'data-[active]:bg-rose-500/5 data-[slot=icon]:*:data-[active]:fill-rose-500',
    // Current
    'data-[slot=icon]:*:data-[current]:fill-rose-500',
    // Dark mode
    'dark:text-white dark:data-[slot=icon]:*:fill-zinc-400',
    'dark:data-[hover]:bg-white/5 dark:data-[slot=icon]:*:data-[hover]:fill-white',
    'dark:data-[active]:bg-white/5 dark:data-[slot=icon]:*:data-[active]:fill-white',
    'dark:data-[slot=icon]:*:data-[current]:fill-white',
    current ? 'text-rose-500' : 'text-neutral-500',
  );
    ...
    <span className={clsx(className, 'relative')}>
      {current && (
        <motion.span
          ...
          className="absolute inset-y-2 -left-4 w-0.5 rounded-full bg-rose-500 dark:bg-white"
        />
      )}
